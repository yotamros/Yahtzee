...
public interface YahtzeeConstants {
    ...
    /** The amount of points needed in the upper category in order to get a bonus*/
    public static final int BONUS_THRESHOLD = 63;
    
    /** The amount bonus amount. */
    public static final int BONUS = 35;
    
    /** The number of turns in each player's round. */
    public static final int ROUND_TURNS = 3;
